...
## 2. Validation
- [ ] 2.1 Manual test on a modern mobile/desktop browser with Web Share support (successful share with score + URL).
- [ ] 2.2 Manual test on a browser without Web Share support (copy-to-clipboard fallback with confirmation).
- [ ] 2.3 Verify share URL opens and replays the same quiz/leaderboard context for the shared quiz id.
